      ...
      *registration.cbl
      *registration.cbl is generated from W:\Webclient\AnnA\whatsapp_registration2\screen\registration.isp
      ...
      *begin {iscobol}run-main-screen
           perform is-registrationScreen-routine
      ...
      *begin {iscobol}copy-procedure
       copy "ismsg.cpy".
       copy "registration.prd".
       copy "registration.evt".
